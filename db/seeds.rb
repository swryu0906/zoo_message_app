...
@c2 = Comment.create(user: @u2, post:@p1, body: "Happy news!!!")
@c3 = Comment.create(user: @u3, post:@p2, body: "How cute!!!!")
@c4 = Comment.create(user: @u1, post:@p2, body: "I love the baby elephant!")
@c5 = Comment.create(user: @u2, post:@p3, body: "I am happy to see the panda!")
@c6 = Comment.create(user: @u3, post:@p3, body: "Good job, Torronto zoo!")
@c7 = Comment.create(user: @u1, post:@p4, body: "Good!!!")
@c8 = Comment.create(user: @u2, post:@p4, body: "How cute!!!!")
@c9 = Comment.create(user: @u3, post:@p5, body: "All national parks should join the program!")
@c10 = Comment.create(user: @u1, post:@p5, body: "Good movement!")
@c11 = Comment.create(user: @u2, post:@p6, body: "I am looking forward to seeing them!!!!")
@c12 = Comment.create(user: @u3, post:@p6, body: "Good news!")
